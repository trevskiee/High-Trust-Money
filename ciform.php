...
<html>
<head>
    <title>Cable/Internet Form</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="content">
        ...
        if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["submit"])) {
            ...
            $sql = "INSERT INTO payment (payment_user_num, category, option_selected, payment_amount, cref_num, name, email, payment_date) VALUES ('$accountNumber', '$category_option', '$ci_option', $amount, '$referencenum', NULL, '$email', NOW())";

            if ($conn->query($sql) === TRUE) {
                // Transaction successfully recorded in the database
                echo "<p>Confirmation: You have initiated a transfer from $accountNumber to $ci_option with the amount of $amount PHP. Thank you!</p>";
        ...
        ?>
        <form action="ciform.php" method="post">
            <label for="category_option">Category:</label>
            <input type="text" id="category_option" name="category_option" placeholder="Cable/Internet">

            <label for="ci_option">Choose:</label>
            <select name="ci_option" id="ci_option">
            <option value="CABLELINK">CABLELINK</option>
