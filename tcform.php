...
<body>
    ...
    <div class="content">
        ...
        if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["submit"])) {
            ...
            $sql = "INSERT INTO payment (payment_user_num, category, option_selected, payment_amount, cref_num, name, email, payment_date) VALUES ('$accountNumber', '$category_option', '$tc_option', $amount, '$referencenum', NULL, '$email', NOW())";

            if ($conn->query($sql) === TRUE) {
                // Transaction successfully recorded in the database
                echo "<p>Confirmation: You have initiated a transfer from $accountNumber to $tc_option with the amount of $amount PHP. Thank you!</p>";
        ...
        ?>
        <form action="tcform.php" method="post">
            <label for="category_option">Category:</label>
            <input type="text" id="category_option" name="category_option" placeholder="Telecoms">

            <label for="tc_option">Choose:</label>
            <select name="tc_option" id="tc_option">
            <option value="CRUZTELCO">CRUZTELCO</option>
            <option value="EASTERN COMMUNICATIONS">EASTERN COMMUNICATIONS</option>
            <option value="GLOBE POSTPAID">GLOBE POSTPAID</option>
