...
<html>
<head>
    <title>Water Utilities Form</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="content">
        ...
        if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["submit"])) {
            ...
            $sql = "INSERT INTO payment (payment_user_num, category, option_selected, payment_amount, cref_num, name, email, payment_date) VALUES ('$accountNumber', '$category_option', '$wu_option', $amount, '$referencenum', NULL, '$email', NOW())";

            if ($conn->query($sql) === TRUE) {
                // Transaction successfully recorded in the database
                echo "<p>Confirmation: You have initiated a transfer from $accountNumber to $wu_option with the amount of $amount PHP. Thank you!</p>";
        ...
        ?>
        <form action="wuform.php" method="post">
            <label for="category_option">Category:</label>
            <input type="text" id="category_option" name="category_option" placeholder="Water Utilities">

            <label for="wu_option">Choose:</label>
            <select name="wu_option" id="wu_option">
            <option value="CDO WATER">CDO WATER</option>
            <option value="FILINVEST WATER">FILINVEST WATER</option>
            <option value="HAPPY WELL">HAPPY WELL</option>
