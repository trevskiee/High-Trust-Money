...
$result = mysqli_query($conn, "SELECT * FROM bankaccount_information ORDER BY ba_id");
?>
                ...
                <div class="container3">
                    <div class = "container3_grid">
                                ...
                                <tbody>
                                    <?php
                                        while($user_data = mysqli_fetch_array($result)) {
                                            echo "<tr>";
                                            echo "<td>".$user_data['ba_id']."</td>";
                                            echo "<td>".$user_data['title']."</td>";
                                            echo "<td>".$user_data['account_holder_name']."</td>";
                                            echo "<td>".$user_data['account_holder_email']."</td>";
                                            echo "<td>".$user_data['account_holder_mobilenum']."</td>";
                                            echo "<td>".$user_data['account_number']."</td>";
                                            echo "<td>".$user_data['account_type']."</td>";
                                            echo "<td>".$user_data['account_datecreated']."</td>";
                                            echo "<td>".$user_data['Address']."</td>";
                                            echo "<td>".$user_data['remaining_balance']."</td>";
                                            echo "<td>".$user_data['notes']."</td>";
                                            echo "<td><a href='banking_update.php?ba_id=$user_data[ba_id]'>Update</a> | <a href='banking_delete.php?ba_id=$user_data[ba_id]'>Delete</a></td></tr>";
                                        }
                                        ?>
                                </tbody>
                            </table>
                        ...
                        <div class = "container3_2">
                            <form action="banking_search.php" method="POST">   
                        ...
                        <div class = "container3_3">
                            <a href="banking_create.php">Add Account</a><br/><br/>  
                        </div>
                    </div>
                </div>
            </div>
