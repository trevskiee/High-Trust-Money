...
<body>
    ...
    <div class="content">
        ...
        if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["submit"])) {
            ...
            $sql = "INSERT INTO payment (payment_user_num, category, option_selected, payment_amount, cref_num, name, email, payment_date) VALUES ('$accountNumber', '$category_option', '$gv_option', $amount, '$referencenum', '$name', '$email', NOW())";

            if ($conn->query($sql) === TRUE) {
                // Transaction successfully recorded in the database
                echo "<p>Confirmation: You have initiated a transfer from $accountNumber to $gv_option with the amount of $amount PHP. Thank you!</p>";
        ...
        ?>
        <form action="gvform.php" method="post">
            <label for="category_option">Category:</label>
            <input type="text" id="category_option" name="category_option" placeholder="Government">

            <label for="gv_option">Choose:</label>
            <select name="gv_option" id="gv_option">
            <option value="DFA">DFA</option>
            <option value="LTFRB">LTFRB</option>
            <option value="NBI">NBI</option>
            <option value="PSA">PSA</option>
            <option value="SOCIAL HOUSING FINANCE">SOCIAL HOUSING FINANCE</option>
            </select>
