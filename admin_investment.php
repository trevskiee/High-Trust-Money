...
$result = mysqli_query($conn, "SELECT * FROM investments ORDER BY investment_id ");
?>
                ...
                <div class="container3">
                    <div class = "container3_grid">
                                ...
                                <tbody>
                                    <?php
                                        while($user_data = mysqli_fetch_array($result)) {
                                            echo "<tr>";
                                            echo "<td>".$user_data['investment_id']."</td>";
                                            echo "<td>".$user_data['full_name']."</td>";
                                            echo "<td>".$user_data['email']."</td>";
                                            echo "<td>".$user_data['phone_number']."</td>";
                                            echo "<td>".$user_data['investment_amount']."</td>";
                                            echo "<td>".$user_data['investment_duration']."</td>";
                                            echo "<td>".$user_data['investment_purpose']."</td>";
                                            echo "<td>".$user_data['investment_date']."</td>";
                                            echo "<td><a href='investment_update.php?investment_id=$user_data[investment_id]'>Update</a> | <a href='investment_delete.php?investment_id=$user_data[investment_id]'>Delete</a></td></tr>";
                                        }
                                        ?>
                                </tbody>
                            </table>
                        ...
                        <div class = "container3_2">
                            <form action="investment_search.php" method="POST">   
                        ...
                        <div class = "container3_3">
                            <a href="investment_create.php">Add Investment Application</a><br/><br/>  
                        </div>
                    </div>
                </div>
            </div>
