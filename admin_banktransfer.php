...
$result = mysqli_query($conn, "SELECT * FROM transactions ORDER BY transaction_id ");
?>
                ...
                <div class="container3">
                    <div class = "container3_grid">
                        <div class = "container3_1">
                            <h1>Transfer from Bank Account</h1>
                            <br>
                            <table class="table">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    <?php
                                        while($user_data = mysqli_fetch_array($result)) {
                                            echo "<tr>";
                                            echo "<td>".$user_data['transaction_id']."</td>";
                                            echo "<td>".$user_data['from_account']."</td>";
                                            echo "<td>".$user_data['from_accountnum']."</td>";
                                            echo "<td>".$user_data['to_account']."</td>";
                                            echo "<td>".$user_data['amount']."</td>";
                                            echo "<td>".$user_data['purpose']."</td>";
                                            echo "<td>".$user_data['transaction_date']."</td>";
                                            echo "<td><a href='transaction_update.php?transaction_id=$user_data[transaction_id]'>Update</a> | <a href='transaction_delete.php?transaction_id=$user_data[transaction_id]'>Delete</a></td></tr>";
                                        }
                                        ?>
                                </tbody>
                            </table>
                        ...
                        <div class = "container3_2">
                            <form action="transaction_search.php" method="POST">   
                        ...
                        <div class = "container3_3">
                            <a href="transaction_create.php">Add Transfer</a><br/><br/>  
                        </div>
                    </div>
                </div>
            </div>
        </div>
<a class="goback-btn" href="admin_payment.php">Go Back</a>
