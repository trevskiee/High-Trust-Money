...
<html>
<head>
    <title>Electric Utilities Form</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="content">
        ...
        if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["submit"])) {
            ...
            $sql = "INSERT INTO payment (payment_user_num, category, option_selected, payment_amount, cref_num, name, email, payment_date) VALUES ('$accountNumber', '$category_option', '$eu_option', $amount, '$referencenum', NULL, '$email', NOW())";

            if ($conn->query($sql) === TRUE) {
                // Transaction successfully recorded in the database
                echo "<p>Confirmation: You have initiated a transfer from $accountNumber to $eu_option with the amount of $amount PHP. Thank you!</p>";
        ...
        ?>
        <form action="euform.php" method="post">
            <label for="category_option">Category:</label>
            <input type="text" id="category_option" name="category_option" placeholder="Electric Utilities">

            <label for="eu_option">Choose:</label>
            <select name="eu_option" id="eu_option">
            <option value="ANECO">ANECO</option>
            <option value="BONI GAS">BONI GAS</option>
            <option value="MERALCO">MERALCO</option>
            <option value="SOLECO">SOLECO</option>
            <option value="ZANECO">ZANECO</option>
            </select>
