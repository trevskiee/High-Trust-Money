...
$result = mysqli_query($conn, "SELECT * FROM payment ORDER BY payment_id ");
?>
    ...
    <div class = "main">
            <div class = "container">
                                ...
                                <tbody>
                                    <?php
                                        while($user_data = mysqli_fetch_array($result)) {
                                            echo "<tr>";
                                            echo "<td>".$user_data['payment_id']."</td>";
                                            echo "<td>".$user_data['payment_user_num']."</td>";
                                            echo "<td>".$user_data['category']."</td>";
                                            echo "<td>".$user_data['option_selected']."</td>";
                                            echo "<td>".$user_data['payment_amount']."</td>";
                                            echo "<td>".$user_data['cref_num']."</td>";
                                            echo "<td>".$user_data['name']."</td>";
                                            echo "<td>".$user_data['email']."</td>";
                                            echo "<td>".$user_data['payment_date']."</td>";
                                            echo "<td><a href='bills_update.php?payment_id=$user_data[payment_id]'>Update</a> | <a href='bills_delete.php?payment_id=$user_data[payment_id]'>Delete</a></td></tr>";
                                        }
                                        ?>
                                </tbody>
                            </table>
                ...
                <div class = "container3_2">
                    <form action="bills_search.php" method="POST">   
                ...
                <div class = "container3_3">
                    <a href="bills_create.php">Add Payment</a><br/><br/>  
                </div>
            </div>
        </div>
