...
$result = mysqli_query($conn, "SELECT * FROM insurance_applications ORDER BY application_id ");
?>
                ...
                <div class="container3">
                    <div class = "container3_grid">
                                ...
                                <tbody>
                                    <?php
                                        while($user_data = mysqli_fetch_array($result)) {
                                            ...
                                            echo "<td>".$user_data['insurance_type']."</td>";
                                            echo "<td>".$user_data['application_date']."</td>";
                                            echo "<td><a href='insurance_update.php?application_id=$user_data[application_id]'>Update</a> | <a href='insurance_delete.php?application_id=$user_data[application_id]'>Delete</a></td></tr>";
                                        }
                                        ?>
                                </tbody>
                            </table>
                        ...
                        <div class = "container3_2">
                            <form action="insurance_search.php" method="POST">   
                        ...
                        <div class = "container3_3">
                            <a href="insurance_create.php">Add Insurance Application</a><br/><br/>  
                        </div>
                    </div>
                </div>
            </div>
